...
namespace Bau.Controls.Graphical
{
	public class ImageZoomBoxPanel : System.Windows.Controls.Panel, INotifyPropertyChanged
	{
		...
		public static void ExecutedEventHandler_RotateHome(Object sender, ExecutedRoutedEventArgs e)
		{
			...
			if (z != null)
				z.process_RotateHomeReverse(true);
		}
		...
		protected override void OnInitialized(EventArgs e)
		{
			...
			MouseWheel += process_MouseWheel;
			MouseDown += process_MouseDown;
			MouseUp += process_MouseUp;
			MouseMove += process_MouseMove;
			PreviewMouseDown += process_PreviewMouseDown;
			PreviewMouseUp += process_PreviewMouseUp;
			PreviewMouseMove += process_PreviewMouseMove;
			ApplyZoom(false);
		...
		protected override Size MeasureOverride(Size availableSize)
		{
			Size panelSize = new Size(150, 150);
				...
				if ((!Double.IsNaN(availableSize.Height)) && (!Double.IsInfinity(availableSize.Height)))
					panelSize.Height = availableSize.Height;
